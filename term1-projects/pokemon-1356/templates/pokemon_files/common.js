var number_original = 0;
var youtube_original = '0';
var d = document;
var originv = 0;
var lengthv = 0;
var ltypev = 0;
...
function togglecol(ind, status) {
    var rows = document.getElementById('table').getElementsByTagName('tr');
    for (var i = 0; i < rows.length; i++) {
        var cells = rows[i].getElementsByTagName('td');
        for (var j = 0; j < cells.length; j++) {
            cells[ind].className = status;
        }
    }
}
...
function toggle0() {
    if (originv === 0) {
        ...
        togglecol(1, 'hyphen1');
        originv = 1;
        document.getElementById('torigin').className = 'off';
    } else {
        togglecol(0, 'origin');
        togglecol(1, 'hyphen');
        originv = 0;
        document.getElementById('torigin').className = 'on';
    }
}

function toggle3() {
    if (creatorv === 0) {
        togglecol(3, 'creator1');
        creatorv = 1;
        document.getElementById('tcreator').className = 'off';
    } else {
        togglecol(3, 'creator');
        creatorv = 0;
        document.getElementById('tcreator').className = 'on';
    }
}
...
function toggle4() {
    if (lengthv === 0) {
        togglecol(4, 'length1');
        lengthv = 1;
        document.getElementById('tlength').className = 'off';
    } else {
        togglecol(4, 'length');
        lengthv = 0;
        document.getElementById('tlength').className = 'on';
    }
}
...
function toggle5() {
    if (sizev === 0) {
        togglecol(5, 'size1');
        sizev = 1;
        document.getElementById('tsize').className = 'off';
    } else {
        togglecol(5, 'size');
        sizev = 0;
        document.getElementById('tsize').className = 'on';
    }
}
...
function toggle6() {
    if (sizev === 0) {
        togglecol(6, 'ltype1');
        sizev = 1;
        document.getElementById('tltype').className = 'off';
    } else {
        togglecol(6, 'ltype');
        sizev = 0;
        document.getElementById('tltype').className = 'on';
    }
}
...
function toggle7() {
    if (lstartv === 0) {
        togglecol(7, 'lstart1');
        lstartv = 1;
        document.getElementById('tlstart').className = 'on';
    } else {
        togglecol(7, 'lstart');
        lstartv = 0;
        document.getElementById('tlstart').className = 'off';
    }
}
...
function toggle8() {
    if (lendv === 0) {
        togglecol(8, 'lend1');
        lendv = 1;
        document.getElementById('tlend').className = 'on';
    } else {
        togglecol(8, 'lend');
        lendv = 0;
        document.getElementById('tlend').className = 'off';
    }
}
...
function toggle9() {
    if (sratev === 0) {
        togglecol(9, 'srate1');
        sratev = 1;
        document.getElementById('tsrate').className = 'on';
    } else {
        togglecol(9, 'srate');
        sratev = 0;
        document.getElementById('tsrate').className = 'off';
    }
}

function toggle10() {
    if (downloadv === 0) {
        togglecol(10, 'download1');
        downloadv = 1;
        document.getElementById('tdownload').className = 'off';
    } else {
        togglecol(10, 'download');
        downloadv = 0;
        document.getElementById('tdownload').className = 'on';
    }
}

function toggle11() {
    if (previewv === 0) {
        togglecol(11, 'preview1');
        previewv = 1;
        document.getElementById('tpreview').className = 'off';
    } else {
        togglecol(11, 'preview');
        previewv = 0;
        document.getElementById('tpreview').className = 'on';
    }
}
var prevplay = '-1';
var prevtype = 's';
function changevideo(file, name, type) {
    if (!type) {
    ...
    case 's':
        if (prevplay != '-1') {
        document.getElementById(prevtype+prevplay).style.backgroundColor = '';
        }
		document.getElementById('footer').innerHTML = '<embed style="display:block;" type="application/x-shockwave-flash" src="/music/FMP3.swf" flashvars="mp3=/music/mp3/' + file + '.mp3&action=play&title=' + name + '&color=000000&loop=no&lma=yes&textcolor=FFFFFF" bgcolor="#FFFFFF" width="260" height="60" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>';
		document.getElementById(eval('"s"+file')).style.backgroundColor = '#00ff00';
        _gaq.push(['_trackEvent', 'MP3', file]);
        break;
    case 'u':
        if (prevplay != '-1') {
     	document.getElementById(prevtype+prevplay).style.backgroundColor = '';
     	}
        document.getElementById('footer').innerHTML = '<embed style="display:block;" type="application/x-shockwave-flash" src="/music/FMP3.swf" flashvars="mp3=/music/update/' + file + '.mp3&action=play&title=' + name + '&color=000000&loop=no&lma=yes&textcolor=FFFFFF" bgcolor="#FFFFFF" width="260" height="60" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>';
        document.getElementById(eval('"u"+file')).style.backgroundColor = '#00ff00';
        break;
    case 'r':
        if (prevplay != '-1') {
        document.getElementById(prevtype+prevplay).style.backgroundColor = '';
        }
        document.getElementById('footer').innerHTML = '<embed style="display:block;" type="application/x-shockwave-flash" src="/music/FMP3.swf" flashvars="mp3=/music/request/' + file + '.mp3&action=play&title=' + name + '&color=000000&loop=no&lma=yes&textcolor=FFFFFF" bgcolor="#FFFFFF" width="260" height="60" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>';
        document.getElementById(eval('"r"+file')).style.backgroundColor = '#00ff00';
        break;
    }
    prevtype = type;
    prevplay = file;
...
function ACS_submitComment(){
  ...
  timesdone++;
  if (timesdone==5) {
  	alert('Stop clicking, it\'s not going to work.');
  }

  if (timesdone==10){
  alert('I already told you, STOP CLICKING. What are you trying to accomplish?');
  }
  return false;
  }
  var ACS_newCommentName = document.getElementById("ACS_newCommentName");
    var ACS_page = document.getElementById("ACS_page");
  var ACS_newCommentMessage = document.getElementById("ACS_newCommentMessage");
    var ACS2_newCommentName = document.getElementById("ACS_newCommentName").value;
    var ACS2_page = document.getElementById("ACS_page").value;
  var ACS2_newCommentMessage = document.getElementById("ACS_newCommentMessage").value;
  ...
  ACS_newCommentSubmit.innerHTML += "ing...";
// ACS_newCommentSubmit.disabled = true;
  ...
  /* remember name or not */
	...
	if (xmlhttp.responseText=='0') {
		...
		ACS_newCommentSubmit.innerHTML = "Post";
	} else if (xmlhttp.responseText=='1') {
		getcomments(1);
		document.getElementById('response').innerHTML = successtext;
		document.getElementById('response').style.visibility = 'visible';
...
var params = "page="+ACS2_page+"&ACS_newCommentName="+ACS2_newCommentName+"&ACS_newCommentMessage="+ACS2_newCommentMessage;
