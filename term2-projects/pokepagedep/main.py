...
#this is a record containing 3 properties 
class Art(db.Model):
...
class DukeHandler(Handler):
	def get(self):
		self.render('duke_tip.html')


app = webapp2.WSGIApplication([
    ('/forum', MainPage),('/tips',TipsHandler),('/',HomeHandler),('/Game',GameHandler),('/duke_tip',DukeHandler)
], debug=True)
